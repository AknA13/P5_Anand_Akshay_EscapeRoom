...
public class WizardsLab extends Room{
	...
	public WizardsLab(String description, String intro, int maxTurns) {
		...
		add(new WandOfKeySummoningRecipe(false, new String[] {"runed_stick", "phoenix_feather", "sapphire", "unicorn_tears"}));
		...
		chest.add(new UselessItem("phoenix_feather", "a feather of orange, yellow and red hues, very warm to the touch"));
		chest.add(new UselessItem("sapphire", "a well cut blue sapphire gem"));
		chest.add(new UselessItem("unicorn_tears", "a bottle of a clear liquid labeled unicorn tears"));
		add(chest);
